      ...
      {showModal && (
        <div style={{
          ...
          <div className="glass-panel pulse-glow" style={{
            background: 'linear-gradient(185deg, rgba(20, 27, 45, 0.95) 0%, rgba(10, 15, 28, 0.98) 100%)',
            border: gameResult === 'win' ? '2.5px solid var(--neon-pink)' : '1px solid rgba(255, 255, 255, 0.1)',
            boxShadow: gameResult === 'win' ? '0 0 35px var(--neon-pink-glow)' : '0 12px 40px rgba(0, 0, 0, 0.6)',
            borderRadius: '28px',
            padding: '40px 32px',
            width: '100%',
            maxWidth: '420px',
            ...
            {gameResult === 'win' && winner ? (
              <>
                ...
                <p style={{ color: 'var(--text-secondary)', fontSize: '13px', margin: '0 0 24px 0' }}>
                  The cyber reels have locked onto your final decision.
                </p>
                <div style={{
                  background: 'rgba(0, 0, 0, 0.4)',
                  ...
                  boxShadow: 'inset 0 0 15px rgba(236, 72, 153, 0.15), 0 0 20px rgba(236, 72, 153, 0.1)',
                  marginBottom: '32px',
              ...
              <>
                ...
                <p style={{ color: 'var(--text-muted)', fontSize: '13px', margin: '0 0 24px 0', lineHeight: 1.4 }}>
                  The reels stopped independently and did not align.
                </p>
                <div style={{
                  display: 'flex',
                  alignItems: 'center',
                  ...
                  <span style={{ color: 'var(--neon-cyan)', fontWeight: 'bold', fontSize: '14px', textShadow: '0 0 6px var(--neon-cyan-glow)' }}>
                    {stoppedItems[0]?.toUpperCase()}
                  </span>
                  <span style={{ color: 'var(--text-muted)', fontSize: '12px' }}>|</span>
                  <span style={{ color: 'var(--neon-purple)', fontWeight: 'bold', fontSize: '14px', textShadow: '0 0 6px var(--neon-purple-glow)' }}>
                    {stoppedItems[1]?.toUpperCase()}
                  </span>
                  <span style={{ color: 'var(--text-muted)', fontSize: '12px' }}>|</span>
                  <span style={{ color: 'var(--neon-pink)', fontWeight: 'bold', fontSize: '14px', textShadow: '0 0 6px var(--neon-pink-glow)' }}>
                    {stoppedItems[2]?.toUpperCase()}
                  </span>
                </div>
              </>
            )}
            ...
            <button 
              ...
              style={{ width: '100%', padding: '12px 24px', fontSize: '14px', fontWeight: 'bold' }}
              onClick={() => setShowModal(false)}
            >
              {gameResult === 'win' ? 'Acknowledge Decision' : 'Try Again'}
            </button>
          </div>
        </div>
      )}
